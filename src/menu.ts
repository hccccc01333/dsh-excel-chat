 ...
 */
export async function buildWorkbookMenu(path: string, sheet?: string): Promise<WorkbookMenu> {
...
function summarize(profile: WorkbookProfile, primary: SheetProfile): string {
  const parts: string[] = []
...
function buildSuggestions(profile: WorkbookProfile, primary: SheetProfile): MenuSuggestion[] {
