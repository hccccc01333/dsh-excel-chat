	...
	factory: (require) => {
		...
		(function(t) {
			...
			function(t, e, n) {
				...
				var o = function() {
					...
					return e = t, (n = [
						...
						},
						{
							key: "active",
							value: function() {
								var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "active";
					...
					return new o(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "");
				};
				n(0);
				function l(t, e) {
					return function(t) {
				...
				var v = function() {
					function t(e, n, r, i) {
						var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0;
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
					...
					return e = t, r = [{
						...
						},
						{
							...
							value: function(e) {
								...
								}, i = this.sri, o = this.sci, a = this.eri, l = this.eci, c = e.sri - i, s = e.sci - o, u = a - e.eri, f = l - e.eci;
					...
					return j(t, [
						{
							...
							value: function(t) {
								...
								null != e && (this.ref = e, this.filters = n.map(function(t) {
				...
				var A = function() {
					...
					return e = t, (n = [
						...
						},
						{
							key: "intersects",
							value: function(t) {
								for (var e = 0; e < this._.length; e += 1) if (this._[e].intersects(t)) return !0;
								return !1;
							}
						},
						{
				...
				var N = function() {
					...
					return e = t, (n = [
						...
						},
						{
							key: "copyPaste",
							value: function(t, e, n) {
								var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : function() {}, o = t.sri, a = t.sci, l = t.eri, c = t.eci, s = e.sri, u = e.sci, f = e.eri, h = e.eci, y = H(t.size(), 2), v = y[0], b = y[1], m = H(e.size(), 2), w = m[0], k = m[1], O = !0, S = 0;
								(f < o || h < a) && (O = !1, S = f < o ? w : k);
								for (var x = o; x <= l; x += 1) if (this._[x]) {
									for (var E = a; E <= c; E += 1) if (this._[x].cells && this._[x].cells[E]) for (var j = s; j <= f; j += v) for (var _ = u; _ <= h; _ += b) {
										var C = j + (x - o), T = _ + (E - a), P = z.cloneDeep(this._[x].cells[E]);
										r && P && P.text && P.text.length > 0 && function() {
											var t = P.text, e = _ - u + (j - s) + 2;
											if (O || (e -= S + 1), "=" === t[0]) P.text = t.replace(/[a-zA-Z]{1,3}\d+/g, function(t) {
												var n = 0, r = 0;
												return o === s ? n = e - 1 : r = e - 1, /^\d+$/.test(t) ? t : p(t, n, r);
											});
											else if (v <= 1 && b > 1 && (s > l || f < o) || b <= 1 && v > 1 && (u > c || h < a) || v <= 1 && b <= 1) {
												var n = /[\\.\d]+$/.exec(t);
												if (null !== n) {
						...
						},
						{
							key: "insert",
							value: function(t) {
								var e = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, r = {};
								this.each(function(i, o) {
									var a = parseInt(i, 10);
									a >= t && (a += n, e.eachCells(i, function(e, r) {
										r.text && "=" === r.text[0] && (r.text = r.text.replace(/[a-zA-Z]{1,3}\d+/g, function(e) {
						...
						},
						{
							key: "delete",
							value: function(t, e) {
								var n = this, r = e - t + 1, i = {};
								this.each(function(o, a) {
									var l = parseInt(o, 10);
									l < t ? i[l] = a : o > e && (i[l - r] = a, n.eachCells(o, function(t, n) {
										n.text && "=" === n.text[0] && (n.text = n.text.replace(/[a-zA-Z]{1,3}\d+/g, function(t) {
							...
							value: function(t) {
								...
								this.each(function(r, i) {
									...
									e.eachCells(r, function(e, r) {
										var i = parseInt(e, 10);
										i >= t && (i += n, r.text && "=" === r.text[0] && (r.text = r.text.replace(/[a-zA-Z]{1,3}\d+/g, function(e) {
							...
							value: function(t, e) {
								...
								this.each(function(i, o) {
									...
									n.eachCells(i, function(n, i) {
										var o = parseInt(n, 10);
										o < t ? a[o] = i : o > e && (a[o - r] = i, i.text && "=" === i.text[0] && (i.text = i.text.replace(/[a-zA-Z]{1,3}\d+/g, function(t) {
						...
						},
						{
							...
							value: function(t, e) {
								...
								if (null !== r) {
									...
									null !== i && !1 !== i.editable && ("all" === n ? delete r.cells[e] : "text" === n ? (i.text && delete i.text, i.value && delete i.value) : "format" === n ? (void 0 !== i.style && delete i.style, i.merge && delete i.merge) : "merge" === n && i.merge && delete i.merge);
								}
							}
						},
						{
				...
				function B(t, e) {
					if (e) for (var n = 0, r = V; n < r.length; n++) {
						var i = r[n];
						if (!e[i]) break;
						for (var o = e[i], a = t.match(/(?:\\.|[^.])+/g), l = 0; l < a.length; l += 1) {
							var c = o[a[l]];
							if (!c) break;
				...
				function Y(t, e) {
					arguments.length > 2 && void 0 !== arguments[2] && arguments[2] ? V = [t] : V.unshift(t), e && (q[t] = e);
				}
				function $(t, e) {
					return function(t) {
						if (Array.isArray(t)) return t;
							...
							value: function(t) {
								...
								if (n) {
									...
									if ("be" === n) {
										...
										return K(o >= this.parseValue(l) && o <= this.parseValue(c), "between", l, c);
									}
									if ("nbe" === n) {
										var s = $(r, 2), u = s[0], f = s[1];
										return K(o < this.parseValue(u) || o > this.parseValue(f), "notBetween", u, f);
									}
									if ("eq" === n) return K(o === this.parseValue(r), "equal", r);
									if ("neq" === n) return K(o !== this.parseValue(r), "notEqual", r);
									if ("lt" === n) return K(o < this.parseValue(r), "lessThan", r);
									if ("lte" === n) return K(o <= this.parseValue(r), "lessThanEqual", r);
									if ("gt" === n) return K(o > this.parseValue(r), "greaterThan", r);
									if ("gte" === n) return K(o >= this.parseValue(r), "greaterThanEqual", r);
								}
								return [!0];
							}
						}
				...
				var nt = function() {
					...
					return et(t, [
						{
							key: "includes",
							value: function(t, e) {
								for (var n = this.refs, r = 0; r < n.length; r += 1) if (v.valueOf(n[r]).includes(t, e)) return !0;
								return !1;
							}
						},
						{
					...
					function t() {
						Q(this, t), this._ = [], this.errors = /* @__PURE__ */ new Map();
					}
					return et(t, [
						{
							key: "getError",
						...
						},
						{
							key: "add",
							value: function(t, e, n) {
								var r = n.type, i = n.required, o = n.value, a = n.operator, l = new J(r, i, o, a), c = this.getByValidator(l);
				...
				function st(t, e) {
					var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function() {}, r = this.merges, i = e.clone(), o = at(t.size(), 2), a = o[0], l = o[1], c = at(e.size(), 2), s = c[0], u = c[1];
				...
				var pt = function() {
					...
					return e = t, (n = [
						...
						},
						{
							...
							value: function() {
								var t = this.selector, e = t.ri, n = t.ci, r = t.range, i = this.validations.get(e, n), o = { ref: r.toString() };
						...
						},
						{
							...
							value: function() {
								if (void 0 !== navigator.clipboard) {
									for (var t = "", e = this.rows.getData(), n = this.selector.range.sri; n <= this.selector.range.eri; n += 1) {
										if (ct(e, n)) {
											for (var r = this.selector.range.sci; r <= this.selector.range.eci; r += 1) if (r > this.selector.range.sci && (t += "	"), ct(e[n].cells, r)) {
												var i = String(e[n].cells[r].text);
												-1 === i.indexOf("\n") && -1 === i.indexOf("	") && -1 === i.indexOf("\"") ? t += i : t += "\"".concat(i, "\"");
											}
										} else for (var o = this.selector.range.sci; o <= this.selector.range.eci; o += 1) t += "	";
										t += "\n";
									}
									navigator.clipboard.writeText(t).then(function() {}, function(e) {
										console.log("text copy to the system clipboard error  ", t, e);
									});
								}
							}
						},
						...
						},
						{
							key: "paste",
							value: function() {
								var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "all", n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function() {}, r = this.clipboard, i = this.selector;
								return !r.isClear() && !!st.call(this, r.range, i.range, n) && (this.changeData(function() {
									r.isCopy() ? ut.call(t, r.range, i.range, e) : r.isCut() && ft.call(t, r.range, i.range);
								}), !0);
							}
						},
						{
						...
						},
						{
							key: "autofill",
							value: function(t, e) {
								var n = this, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function() {}, i = this.selector.range;
								return !!st.call(this, i, t, r) && (this.changeData(function() {
									ut.call(n, i, t, e, !0);
								}), !0);
							}
						},
						...
						},
						{
							...
							value: function(t, e) {
								var n = this.selector, r = this.rows, i = this.cols, o = this.merges, a = n.range, l = a.sri, c = a.sci, s = a.eri, u = a.eci, f = n.ri, h = n.ci, p = t, d = e;
							...
							value: function(t, e) {
								...
								this.changeData(function() {
									...
									if ("merge" === t) e ? n.merge() : n.unmerge();
										...
										var e = this, n = t.mode, r = t.style, i = t.color, o = this.styles, a = this.selector, l = this.rows, c = a.range, s = c.sri, u = c.sci, f = c.eri, h = c.eci, p = !this.isSignleSelected();
											...
											if ("none" === n) a.range.each(function(t, n) {
												...
												for (var t = [], o = s; o <= f; o += 1) for (var a = u; a <= h; a += 1) {
													...
													"all" === n ? j = {
														...
														left: [r, i],
														right: [r, i]
													} : "inside" === n ? (!E && a < h && (j.right = [r, i]), !x && o < f && (j.bottom = [r, i])) : "horizontal" === n ? !x && o < f && (j.bottom = [r, i]) : "vertical" === n ? !E && a < h && (j.right = [r, i]) : "outside" === n && p && (s === o && (j.top = [r, i]), (x || f === o) && (j.bottom = [r, i]), u === a && (j.left = [r, i]), (E || h === a) && (j.right = [r, i])), Object.keys(j).length > 0 && ht.call(e, o, a, j), a += O;
												}
											})();
											else if ("top" === n || "bottom" === n) for (var d = u; d <= h; d += 1) "top" === n && (ht.call(this, s, d, { top: [r, i] }), d += l.getCellMerge(s, d)[1]), "bottom" === n && (ht.call(this, f, d, { bottom: [r, i] }), d += l.getCellMerge(f, d)[1]);
											else if ("left" === n || "right" === n) for (var y = s; y <= f; y += 1) "left" === n && (ht.call(this, y, u, { left: [r, i] }), y += l.getCellMerge(y, u)[0]), "right" === n && (ht.call(this, y, h, { right: [r, i] }), y += l.getCellMerge(y, h)[0]);
										} else ht.call(this, s, u, {
											top: [r, i],
											bottom: [r, i],
											left: [r, i],
											right: [r, i]
										...
										if (r.multiple()) {
											...
											if (u > 1) for (var b = d; b <= v; b += 1) o.getCellOrNew(y + 1, b).text = "=".concat(e, "(").concat(h(b, p), ":").concat(h(b, y), ")");
											else if (f > 1) o.getCellOrNew(a, v + 1).text = "=".concat(e, "(").concat(h(d, a), ":").concat(h(v, a), ")");
										} else o.getCellOrNew(a, l).text = "=".concat(e, "()");
						...
						},
						{
							...
							value: function(t) {
								var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "input", n = this.autoFilter, r = this.selector, i = this.rows, o = r.ri, a = r.ci, l = o;
						...
						},
						{
							...
							value: function(t, e) {
								var n = this.getSelectedRect(), r = n.left, i = n.top, o = n.width, a = n.height, l = t - this.cols.indexWidth, c = e - this.rows.height;
						...
						},
						{
							key: "getRect",
							value: function(t) {
								var e = this.scroll, n = this.rows, r = this.cols, i = this.exceptRowSet, o = t.sri, a = t.sci, l = t.eri, c = t.eci;
								if (o < 0 && a < 0) return {
									left: 0,
									l: 0,
									top: 0,
								...
								var s = r.sumWidth(0, a), u = n.sumHeight(0, o, i), f = n.sumHeight(o, l + 1, i), h = r.sumWidth(a, c + 1), p = s - e.x, d = u - e.y, y = this.freezeTotalHeight(), v = this.freezeTotalWidth();
						...
						},
						{
							...
							value: function() {
								...
								this.changeData(function() {
									e.active() ? (e.clear(), t.exceptRowSet = /* @__PURE__ */ new Set(), t.sortedRowMap = /* @__PURE__ */ new Map(), t.unsortedRowMap = /* @__PURE__ */ new Map()) : e.ref = n.range.toString();
								});
							}
						},
						{
						...
						},
						{
							...
							value: function() {
								...
								if (e.active()) {
									...
									}), this.exceptRowSet = o, this.sortedRowMap = /* @__PURE__ */ new Map(), this.unsortedRowMap = /* @__PURE__ */ new Map(), l.forEach(function(e, n) {
						...
						},
						{
							key: "deleteCell",
							value: function() {
								var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "all", n = this.selector;
								this.changeData(function() {
						...
						},
						{
							...
							value: function(t) {
								var e = this;
								this.changeData(function() {
									var n = e.rows, r = e.merges, i = e.selector, o = e.cols, a = i.range, l = i.range, c = l.sri, s = l.sci, u = l.eri, f = l.eci, h = at(i.range.size(), 2), p = h[0], d = h[1], y = c, v = p;
						...
						},
						{
							key: "scrollx",
							value: function(t, e) {
								var n = this.scroll, r = this.freeze, i = this.cols, o = at(r, 2)[1], a = at(z.rangeReduceIf(o, i.len, 0, 0, t, function(t) {
									return i.getWidth(t);
						...
						},
						{
							key: "scrolly",
							value: function(t, e) {
								var n = this.scroll, r = this.freeze, i = this.rows, o = at(r, 1)[0], a = at(z.rangeReduceIf(o, i.len, 0, 0, t, function(t) {
						...
						},
						{
							key: "cellRect",
							value: function(t, e) {
								var n = this.rows, r = this.cols, i = r.sumWidth(0, e), o = n.sumHeight(0, t), a = n.getCell(t, e), l = r.getWidth(e), c = n.getHeight(t);
								if (null !== a && a.merge) {
						...
						},
						{
							key: "viewHeight",
							value: function() {
								var t = this.settings, e = t.view, n = t.showToolbar, r = t.showBottomBar, i = e.height();
						...
						},
						{
							...
							value: function() {
								...
								return new v(0, 0, r, i, e.sumWidth(0, i + 1), o);
							}
						},
						{
						...
						},
						{
							key: "viewRange",
							value: function() {
								var t = this.scroll, e = this.rows, n = this.cols, r = this.freeze, i = this.exceptRowSet, o = t.ri, a = t.ci;
								o <= 0 && (o = at(r, 1)[0]);
								a <= 0 && (a = at(r, 2)[1]);
						...
						},
						{
							key: "hideRowsOrCols",
							value: function() {
								var t = this.rows, e = this.cols, n = this.selector, r = at(n.size(), 2), i = r[0], o = r[1], a = n.range, l = a.sri, c = a.sci, s = a.eri, u = a.eci;
								if (i === t.len) for (var f = c; f <= u; f += 1) e.setHide(f, !0);
								else if (o === e.len) for (var h = l; h <= s; h += 1) t.setHide(h, !0);
							}
						},
						{
						...
						},
						{
							...
							value: function(t, e, n) {
								...
								for (var s = t + l; s <= e + l; s += 1) if (o.has(s)) l += 1;
								else {
									var u = i.getHeight(s);
						...
						},
						{
							key: "getData",
							value: function() {
								var t = this.name, e = this.freeze, n = this.styles, r = this.merges, i = this.rows, o = this.cols, a = this.validations, l = this.autoFilter;
								return {
									name: t,
									freeze: h(e[1], e[0]),
									styles: n,
				...
				function bt(t) {
					t.xclickoutside && (vt(window.document.body, "click", t.xclickoutside), delete t.xclickoutside);
				}
				function gt(t, e) {
					t.xclickoutside = function(n) {
						2 === n.detail || t.contains(n.target) || (e ? e(t) : (t.hide(), bt(t)));
					}, yt(window.document.body, "click", t.xclickoutside);
				}
				function mt(t, e, n) {
					yt(t, "mousemove", e), t.xEvtUp = function(r) {
				...
				var St = function() {
					function t() {
						var e = this, n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], r = arguments.length > 1 ? arguments[1] : void 0;
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, t), this.moving = !1, this.vertical = n, this.el = a("div", "".concat(kt, "-resizer ").concat(n ? "vertical" : "horizontal")).children(this.unhideHoverEl = a("div", "".concat(kt, "-resizer-hover")).on("dblclick.stop", function(t) {
							return e.mousedblclickHandler(t);
						}).css("position", "absolute").hide(), this.hoverEl = a("div", "".concat(kt, "-resizer-hover")).on("mousedown.stop", function(t) {
					...
					return e = t, (n = [
						...
						},
						{
							key: "show",
							value: function(t, e) {
								var n = this.moving, r = this.vertical, i = this.hoverEl, o = this.lineEl, a = this.el, l = this.unhideHoverEl;
								if (!n) {
									this.cRect = t;
						...
						},
						{
							...
							value: function(t) {
								var e = this, n = t, r = this.el, i = this.lineEl, o = this.cRect, a = this.vertical, l = this.minDistance, c = a ? o.width : o.height;
								i.show(), mt(window, function(t) {
				...
				var Et = function() {
					function t(e) {
						...
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, t), this.vertical = e, this.moveFn = null, this.el = a("div", "".concat(kt, "-scrollbar ").concat(e ? "vertical" : "horizontal")).child(this.contentEl = a("div", "")).on("mousemove.stop", function() {}).on("scroll.stop", function(t) {
				...
				var Tt = 10, Pt = function() {
					function t() {
						var e = this, n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
						jt(this, t), this.useHideInput = n, this.inputChange = function() {}, this.cornerEl = a("div", "".concat(kt, "-selector-corner")), this.areaEl = a("div", "".concat(kt, "-selector-area")).child(this.cornerEl).hide(), this.clipboardEl = a("div", "".concat(kt, "-selector-clipboard")).hide(), this.autofillEl = a("div", "".concat(kt, "-selector-autofill")).hide(), this.el = a("div", "".concat(kt, "-selector")).css("z-index", "".concat(Tt)).children(this.areaEl, this.clipboardEl, this.autofillEl).hide(), n && (this.hideInput = a("input", "").on("compositionend", function(t) {
							e.inputChange(t.target.value);
						}), this.el.child(this.hideInputDiv = a("div", "hide-input").child(this.hideInput)), this.el.child(this.hideInputDiv = a("div", "hide-input").child(this.hideInput))), Tt += 1;
					}
					return Ct(t, [
						{
							key: "setOffset",
				...
				function At(t) {
					var e = this.data, n = t.left, r = t.top, i = t.width, o = t.height, a = t.scroll, l = t.l, c = t.t, s = e.freezeTotalWidth(), u = e.freezeTotalHeight(), f = n - s;
					s > l && (f -= a.x);
					var h = r - u;
					return u > c && (h -= a.y), {
						left: f,
				...
				function Rt(t) {
					var e = this.data, n = t.left, r = t.width, i = t.height, o = t.l, a = t.t, l = t.scroll, c = e.freezeTotalWidth(), s = n - c;
					return c > o && (s -= l.x), {
						left: s,
						top: a,
						width: r,
				...
				function It(t) {
					var e = this.data, n = t.top, r = t.width, i = t.height, o = t.l, a = t.t, l = t.scroll, c = e.freezeTotalHeight(), s = n - c;
					return c > a && (s -= l.y), {
						left: o,
						top: s,
						width: r,
				...
				function Wt(t) {
					Dt.call(this, t), function(t) {
						this.tl.setAreaOffset(t);
					}.call(this, t), zt.call(this, t), Ht.call(this, t);
				}
				function Vt(t) {
					Nt.call(this, t), function(t) {
						this.tl.setClipboardOffset(t);
					}.call(this, t), Ft.call(this, t), Mt.call(this, t);
				}
				var qt = function() {
					function t(e) {
						var n = this;
						jt(this, t), this.inputChange = function() {}, this.data = e, this.br = new Pt(!0), this.t = new Pt(), this.l = new Pt(), this.tl = new Pt(), this.br.inputChange = function(t) {
							n.inputChange(t);
						}, this.br.el.show(), this.offset = null, this.areaOffset = null, this.indexes = null, this.range = null, this.arange = null, this.el = a("div", "".concat(kt, "-selectors")).children(this.tl.el, this.t.el, this.l.el, this.br.el).hide(), this.lastri = -1, this.lastci = -1, Tt += 1;
					}
					return Ct(t, [
						{
							key: "resetData",
						...
						},
						{
							key: "resetOffset",
							value: function() {
								var t = this.data, e = this.tl, n = this.t, r = this.l, i = this.br, o = t.freezeTotalHeight(), a = t.freezeTotalWidth();
								o > 0 || a > 0 ? (e.setOffset({
									width: a,
									height: o
								}), n.setOffset({
						...
						},
						{
							...
							value: function() {
								var t = this.data.getSelectedRect(), e = this.data.getClipboardRect();
								Dt.call(this, t), zt.call(this, t), Nt.call(this, e), Ft.call(this, e), this.resetOffset();
							}
						},
						{
							...
							value: function() {
								var t = this.data.getSelectedRect(), e = this.data.getClipboardRect();
								Dt.call(this, t), Ht.call(this, t), Nt.call(this, e), Mt.call(this, e), this.resetOffset();
							}
						},
						{
							key: "set",
							value: function(t, e) {
								var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], r = this.data, i = r.calSelectedRangeByStart(t, e), o = i.sri, a = i.sci;
								if (n) {
									var l = t, c = e;
						...
						},
						{
							key: "setEnd",
							value: function(t, e) {
								var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], r = this.data, i = this.lastri, o = this.lastci;
								if (n) {
									if (t === i && e === o) return;
									this.lastri = t, this.lastci = e;
								}
								this.range = r.calSelectedRangeByEnd(t, e), Wt.call(this, this.data.getSelectedRect());
							}
						},
						{
							key: "reset",
							...
							value: function(t, e) {
								if (-1 !== t || -1 !== e) {
									...
									if (null !== this.arange) {
										...
										p.showAutofill(At.call(this, h)), d.showAutofill(It.call(this, h)), y.showAutofill(Rt.call(this, h)), b.showAutofill(h);
									}
								}
							}
						},
				...
				var Yt = function() {
					...
					return e = t, (n = [
						...
						},
						{
							...
							value: function() {
								var t = this.el;
								this.filterItems = [], this.itemIndex = -1, t.hide(), bt(this.el.parent());
							}
						},
						{
							key: "setItems",
						...
						},
						{
							...
							value: function(t) {
								...
								if (/^\s*$/.test(t) || (r = r.filter(function(e) {
									...
									var r = a("div", "".concat(kt, "-item")).child(e).on("click.stop", function() {
										n.itemClick(t), n.hide();
									});
									return t.label && r.child(a("div", "label").html(t.label)), r;
								}), this.filterItems = r, !(r.length <= 0)) {
									var i = this.el;
									(e = i.html("")).children.apply(e, Bt(r)).show(), gt(i.parent(), function() {
										n.hide();
									});
								}
							}
				...
				var Gt = function(t) {
					function e(t) {
						...
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), (n = Zt(this, Kt(e).call(this, "div", "".concat(kt, "-icon")))).iconNameEl = a("div", "".concat(kt, "-icon-img ").concat(t)), n.child(n.iconNameEl), n;
					}
					var n, r, i;
					return function(t, e) {
				...
				var re = function() {
					function t(e) {
						...
						(function(t, e) {
							...
							return r.prev();
						}).child(new Gt("chevron-left")), a("a", "calendar-next").on("click.stop", function() {
							return r.next();
						}).child(new Gt("chevron-right")))), a("table", "calendar-body").children(a("thead", "").child((n = a("tr", "")).children.apply(n, Qt(L("calendar.weeks").map(function(t) {
							...
							value: function() {
								var t, e = this, n = this.value, r = this.cvalue, i = this.bodyEl, o = function(t, e, n) {
									for (var r = new Date(t, e, 1, 23, 59, 59), i = [
										...
										[],
										[]
									], o = 0; o < 6; o += 1) for (var a = 0; a < 7; a += 1) {
										var l = ne(r, 7 * o + a), c = l.getMonth() !== e, s = l.getMonth() === n.getMonth() && l.getDate() === n.getDate();
										i[o][a] = {
											d: l,
											disabled: c,
											active: s
					...
					return e = t, (n = [
						{
							...
							value: function(t) {
								var e = this.calendar;
								return "string" == typeof t ? /^\d{4}-\d{1,2}-\d{1,2}$/.test(t) && e.setValue(new Date(t.replace(/* @__PURE__ */ new RegExp("-", "g"), "/"))) : t instanceof Date && e.setValue(t), this;
							}
						},
						{
							key: "change",
				...
				function ce() {
					...
					if (!/^\s*$/.test(t)) {
						var e = this.textlineEl, n = this.textEl, r = this.areaOffset, i = t.split("\n"), o = Math.max.apply(Math, le(i.map(function(t) {
							return t.length;
						}))), a = e.offset().width / t.length, l = (o + 1) * a + 5, c = this.viewFn().width - r.left - a, s = i.length;
						if (l > r.width) {
							var u = l;
				...
				function se(t) {
					...
					13 !== e && 9 !== e && t.stopPropagation(), 13 === e && n && (function(t, e) {
						var n = t.target, r = n.value, i = n.selectionEnd, o = "".concat(r.slice(0, i)).concat(e).concat(r.slice(i));
						n.value = o, n.setSelectionRange(i + 1, i + 1), this.inputText = o, this.textlineEl.html(o), ce.call(this);
				...
				var fe = function() {
					function t(e, n, r) {
						...
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, t), this.viewFn = n, this.rowHeight = r, this.formulas = e, this.suggest = new Yt(e, function(t) {
							(function(t) {
						...
						}), this.datepicker = new oe(), this.datepicker.change(function(t) {
						...
						}), this.areaEl = a("div", "".concat(kt, "-editor-area")).children(this.textEl = a("textarea", "").on("input", function(t) {
							return function(t) {
							...
							return se.call(i, t);
						}), this.textlineEl = a("div", "textline"), this.suggest.el, this.datepicker.el).on("mousemove.stop", function() {}).on("mousedown.stop", function() {}), this.el = a("div", "".concat(kt, "-editor")).child(this.areaEl).hide(), this.suggest.bindInputEvents(this.textEl), this.areaOffset = null, this.freeze = {
							w: 0,
							h: 0
					...
					return e = t, (n = [
						...
						},
						{
							key: "setOffset",
							value: function(t) {
								var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "top", n = this.textEl, r = this.areaEl, i = this.suggest, o = this.freeze, a = this.el;
								if (t) {
									this.areaOffset = t;
									var l = t.left, c = t.top, s = t.width, u = t.height, f = t.l, h = t.t, p = {
										left: 0,
										top: 0
									};
				...
				var ve = function(t) {
					function e(t) {
						...
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), (n = pe(this, de(e).call(this, "div", "".concat(kt, "-button ").concat(r)))).child(L("button.".concat(t))), n;
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var je = function() {
					function t(e, n, r, i) {
						...
						me(this, t), this.x = e, this.y = n, this.width = r, this.height = i, this.padding = o, this.bgcolor = "#ffffff", this.borderTop = null, this.borderRight = null, this.borderBottom = null, this.borderLeft = null;
					}
					return ke(t, [
						{
							key: "setBorders",
				...
				var Ce = function() {
					function t(e, n, r) {
						me(this, t), this.el = e, this.ctx = e.getContext("2d"), this.resize(n, r), this.ctx.scale(Oe(), Oe());
					}
					return ke(t, [
						{
							key: "resize",
							value: function(t, e) {
								this.el.style.width = "".concat(t, "px"), this.el.style.height = "".concat(e, "px"), this.el.width = xe(t), this.el.height = xe(e);
							}
						},
						{
							key: "clear",
						...
						},
						{
							key: "fillRect",
							value: function(t, e, n, r) {
								return this.ctx.fillRect(xe(t) - .5, xe(e) - .5, xe(n), xe(r)), this;
							}
						},
						{
							key: "fillText",
						...
						},
						{
							key: "text",
							value: function(t, e) {
								var n = this, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3], o = this.ctx, a = r.align, l = r.valign, c = r.font, s = r.color, u = r.strike, f = r.underline, h = e.textx(a);
								o.save(), o.beginPath(), this.attr({
									textAlign: a,
									textBaseline: l,
									font: "".concat(c.italic ? "italic" : "", " ").concat(c.bold ? "bold" : "", " ").concat(xe(c.size), "px ").concat(c.name),
									fillStyle: s,
									strokeStyle: s
								});
								...
								p.forEach(function(t) {
									...
									if (i && e > xe(d)) {
										for (var n = {
											...
											len: 0,
											start: 0
										}, r = 0; r < t.length; r += 1) n.w >= xe(d) && (y.push(t.substr(n.start, n.len)), n = {
											w: 0,
											len: 0,
											start: r
								...
								return y.forEach(function(t) {
									var e = o.measureText(t).width;
									n.fillText(t, h, b), u && _e.call(n, "strike", h, b, a, l, c.size, e), f && _e.call(n, "underline", h, b, a, l, c.size, e), b += c.size + 2;
								}), o.restore(), this;
							}
						},
						{
							...
							value: function(t, e) {
								var n = this.ctx;
								return n.lineWidth = Se, n.strokeStyle = e, "medium" === t ? n.lineWidth = xe(2) - .5 : "thick" === t ? n.lineWidth = xe(3) : "dashed" === t ? n.setLineDash([xe(3), xe(2)]) : "dotted" === t ? n.setLineDash([xe(1), xe(1)]) : "double" === t && n.setLineDash([xe(2), 0]), this;
							}
						},
						{
							key: "line",
							value: function() {
								...
								if (arguments.length > 1) {
									t.beginPath();
									var n = ge(arguments.length <= 0 ? void 0 : arguments[0], 2), r = n[0], i = n[1];
									t.moveTo(Ee(r), Ee(i));
									for (var o = 1; o < arguments.length; o += 1) {
										var l = ge(o < 0 || arguments.length <= o ? void 0 : arguments[o], 2), c = l[0], s = l[1];
										t.lineTo(Ee(c), Ee(s));
									}
									t.stroke();
								}
						...
						},
						{
							...
							value: function(t) {
								...
								n && (this.border.apply(this, be(n)), this.line.apply(this, be(t.topxys()))), r && (this.border.apply(this, be(r)), this.line.apply(this, be(t.rightxys()))), i && (this.border.apply(this, be(i)), this.line.apply(this, be(t.bottomxys()))), o && (this.border.apply(this, be(o)), this.line.apply(this, be(t.leftxys()))), e.restore();
							}
						},
						{
							key: "dropdown",
							value: function(t) {
								...
								e.save(), e.beginPath(), e.moveTo(xe(i), xe(o)), e.lineTo(xe(i + 8), xe(o)), e.lineTo(xe(i + 4), xe(o + 6)), e.closePath(), e.fillStyle = "rgba(0, 0, 0, .45)", e.fill(), e.restore();
							}
						},
						{
							key: "error",
							value: function(t) {
								...
								e.save(), e.beginPath(), e.moveTo(xe(i - 8), xe(r - 1)), e.lineTo(xe(i), xe(r - 1)), e.lineTo(xe(i), xe(r + 8)), e.closePath(), e.fillStyle = "rgba(255, 0, 0, .65)", e.fill(), e.restore();
							}
						},
						{
							key: "frozen",
							value: function(t) {
								var e = this.ctx, n = t.x, r = t.y, i = n + t.width - 1;
								e.save(), e.beginPath(), e.moveTo(xe(i - 8), xe(r - 1)), e.lineTo(xe(i), xe(r - 1)), e.lineTo(xe(i), xe(r + 8)), e.closePath(), e.fillStyle = "rgba(0, 255, 0, .85)", e.fill(), e.restore();
							}
						},
						{
							key: "rect",
							value: function(t, e) {
								...
								n.save(), n.beginPath(), n.fillStyle = l || "#fff", n.rect(Ee(r + 1), Ee(i + 1), xe(o - 2), xe(a - 2)), n.clip(), n.fill(), e(), n.restore();
							}
						}
					]), t;
				}(), Te = [
				...
				var Re = function(t) {
						...
						if (" " !== s) {
							if (s >= "a" && s <= "z") r.push(s.toUpperCase());
								...
								if ("(" !== s && r.length > 0 && n.push(r.join("")), ")" === s) {
									var u = e.pop();
									if (2 === i) try {
										for (var p = Ae(f(n.pop()), 2), d = p[0], y = p[1], v = Ae(f(n.pop()), 2), b = v[0], g = v[1], m = 0, w = b; w <= d; w += 1) for (var k = g; k <= y; k += 1) n.push(h(w, k)), m += 1;
										n.push([u, m]);
									} catch (t) {}
									else if (1 === i || 3 === i) 3 === i && n.push(o), n.push([u, a]), a = 1;
									else for (; "(" !== u && (n.push(u), !(e.length <= 0));) u = e.pop();
									i = 0;
								} else if ("=" === s || ">" === s || "<" === s) {
									var O = t.charAt(c + 1);
									o = s, "=" !== O && "-" !== O || (o += O, c += 1), i = 3;
					...
					for (var i = [], o = 0; o < t.length; o += 1) {
						...
						if ("+" === a) {
							...
							for (var y = Ae(a, 2), v = y[0], b = y[1], g = [], m = 0; m < b; m += 1) g.push(i.pop());
							i.push(e[v].render(g.reverse()));
						} else {
							if (r.includes(a)) return 0;
							(l >= "a" && l <= "z" || l >= "A" && l <= "Z") && r.push(a), i.push(Ie(a, n)), r.pop();
						}
					}
					return i[0];
				}, ze = { render: function t(e, n, r) {
				...
				var Ne = [
					...
					},
					{
						...
						title: U("formula._if"),
						render: function(t) {
							var e = He(t, 3), n = e[0], r = e[1], i = e[2];
							return n ? r : i;
						}
					},
					{
				...
				var Le = function(t) {
					...
					if (/^(-?\d*.?\d*)$/.test(t)) {
						var e = qe(Number(t).toFixed(2).toString().split("\\.")), n = e[0], r = e.slice(1);
				...
				var Ke = 5, Je = { fillStyle: "#f4f5f8" }, Ge = {
					fillStyle: "#fff",
					lineWidth: Se,
					strokeStyle: "#e6e6e6"
				};
				function Qe(t, e, n) {
					var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, i = t.cellRect(e, n), o = i.left, a = i.top, l = i.width, c = i.height;
					return new je(o, a + r, l, c, Ke);
				}
				function tn(t, e, n, r) {
					var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, o = e.sortedRowMap, a = e.rows, l = e.cols;
					if (!a.isHide(n) && !l.isHide(r)) {
						...
						if (null !== s) {
							...
							var f = e.getCellStyleOrDefault(c, r), h = Qe(e, n, r, i);
							h.bgcolor = f.bgcolor, void 0 !== f.border && (h.setBorders(f.border), t.strokeBorders(h)), t.rect(h, function() {
								var i = "";
								i = e.settings.evalPaused ? s.text || "" : ze.render(s.text || "", We, function(t, n) {
				...
				function rn(t, e, n, r, i, o) {
					...
					l.save(), l.attr(Je), "all" !== t && "left" !== t || l.fillRect(0, h, n, u), "all" !== t && "top" !== t || l.fillRect(p, 0, f, r);
					...
					l.attr({
						...
						var i = h + e, o = t;
						l.line([0, i], [n, i]), y <= o && o < b + 1 && nn.call(a, 0, i, n, r), l.fillText(o + 1, n / 2, i + r / 2), t > 0 && c.rows.isHide(t - 1) && (l.save(), l.attr({ strokeStyle: "#c6c6c6" }), l.line([5, i + 5], [n - 5, i + 5]), l.restore());
					}), l.line([0, u + h], [n, u + h]), l.line([n, h], [n, u + h])), "all" !== t && "top" !== t || (c.colEach(e.sci, e.eci, function(t, e, n) {
						var i = p + e, o = t;
						l.line([i, 0], [i, r]), v <= o && o < g + 1 && nn.call(a, i, 0, n, r), l.fillText(s(o), i + n / 2, r / 2), t > 0 && c.cols.isHide(t - 1) && (l.save(), l.attr({ strokeStyle: "#c6c6c6" }), l.line([i + 5, 5], [i + 5, r - 5]), l.restore());
				...
				function on(t, e, n, r, i) {
					...
					f.save(), f.attr(Ge).translate(e + r, n + i), p.showGrid ? (h.rowEach(o, l, function(t, e, n) {
					...
					return e = t, (n = [
						...
						},
						{
							...
							value: function() {
								...
								var i = t.viewRange(), o = t.freezeTotalWidth(), a = t.freezeTotalHeight(), l = t.scroll, c = l.x, s = l.y;
								on.call(this, i, n, r, o, a), en.call(this, i, n, r, -c, -s), rn.call(this, "all", i, n, r, o, a), function(t, e) {
									var n = this.draw;
									n.save(), n.attr({ fillStyle: "#f4f5f8" }).fillRect(0, 0, t, e), n.restore();
								}.call(this, n, r);
								var u = Xe(t.freeze, 2), f = u[0], h = u[1];
								if (f > 0 || h > 0) {
									if (f > 0) {
										var p = i.clone();
										p.sri = 0, p.eri = f - 1, p.h = a, on.call(this, p, n, r, o, 0), en.call(this, p, n, r, -c, 0), rn.call(this, "top", p, n, r, o, 0);
									}
									if (h > 0) {
										var d = i.clone();
										d.sci = 0, d.eci = h - 1, d.w = o, on.call(this, d, n, r, 0, a), rn.call(this, "left", d, n, r, 0, a), en.call(this, d, n, r, 0, -s);
									}
									var y = t.freezeViewRange();
									on.call(this, y, n, r, 0, 0), rn.call(this, "all", y, n, r, 0, 0), en.call(this, y, n, r, 0, 0), function(t, e, n, r) {
				...
				var pn = function() {
					...
					return e = t, (n = [
						...
						},
						{
							key: "preview",
							value: function() {
								var t = this, e = this.data, n = this.paper, r = n.width, i = n.height, o = n.padding, l = r - 2 * o, c = i - 2 * o, s = e.contentRange(), u = parseInt(s.h / c, 10) + 1, f = l / s.w, h = o, p = o;
								f > 1 && (h += (l - s.w) / 2);
								var d = 0, y = 0;
								...
								for (var v = {
									...
									var o = 0, l = 0, u = a("div", "".concat(kt, "-canvas-card")), b = a("canvas", "".concat(kt, "-canvas"));
									...
									for (g.save(), g.translate(h, p), f < 1 && g.scale(f, f); d <= s.eri; d += 1) {
										...
										for (var w = 0; w <= s.eci; w += 1) tn(g, e, d, w, y), v.eci = w;
									}
									...
									e.eachMergesInView(v, function(t) {
										var n = t.sri, r = t.sci;
										tn(g, e, n, r, k);
									}), g.restore(), v.sri = v.eri, v.sci = v.eci, y += l, t.contentEl.child(a("div", "".concat(kt, "-canvas-card-wraper")).child(u.child(b)));
								}, g = 0; g < u; g += 1) b();
								this.el.show();
							}
						},
				...
				function bn() {
					...
					return vn.map(function(e) {
						return function(t) {
							var e = this;
							return "divider" === t.key ? a("div", "".concat(kt, "-item divider")) : a("div", "".concat(kt, "-item")).on("click", function() {
				...
				var wn = function() {
					...
					return e = t, (n = [{
						...
						value: function() {
							var t = this.tip;
							return a("div", "".concat(kt, "-toolbar-btn")).on("mouseenter", function(e) {
								(function(t, e) {
									if (!e.classList.contains("active")) {
										var n = e.getBoundingClientRect(), r = n.left, i = n.top, o = n.width, l = n.height, c = a("div", "".concat(kt, "-tooltip")).html(t).show();
										document.body.appendChild(c.el);
										var s = c.box();
										c.css("left", "".concat(r + o / 2 - s.width / 2, "px")).css("top", "".concat(i + l + 2, "px")), yt(e, "mouseleave", function() {
				...
				function xn(t, e, n) {
					return (xn = "undefined" != typeof Reflect && Reflect.get ? Reflect.get : function(t, e, n) {
						var r = function(t, e) {
				...
				var _n = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Sn(this, En(e).apply(this, arguments));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var In = function(t) {
					function e(t, n, r, i) {
						...
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, e), (l = Pn(this, An(e).call(this, "div", "".concat(kt, "-dropdown ").concat(i)))).title = t, l.change = function() {}, l.headerClick = function() {}, "string" == typeof t ? l.title = a("div", "".concat(kt, "-dropdown-title")).child(t) : r && l.title.addClass("arrow-left"), l.contentEl = a("div", "".concat(kt, "-dropdown-content")).css("width", n).hide();
						for (var c = arguments.length, s = new Array(c > 4 ? c - 4 : 0), u = 4; u < c; u++) s[u - 4] = arguments[u];
						return (o = l).setContentChildren.apply(o, s), l.headerEl = a("div", "".concat(kt, "-dropdown-header")), l.headerEl.on("click", function() {
							"block" !== l.contentEl.css("display") ? l.show() : l.hide();
						}).children(l.title, r ? a("div", "".concat(kt, "-icon arrow-right")).child(a("div", "".concat(kt, "-icon-img arrow-down"))) : ""), l.children(l.headerEl, l.contentEl), l;
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						...
						},
						{
							...
							value: function() {
								var t = this;
								this.contentEl.show(), this.parent().active(), gt(this.parent(), function() {
									t.hide();
								});
							}
						},
						{
							key: "hide",
							value: function() {
								this.parent().active(!1), this.contentEl.hide(), bt(this.parent());
							}
						}
					]) && Tn(n.prototype, r), i && Tn(n, i), e;
				}();
				function Dn(t) {
				...
				var Wn = function(t) {
					function e(t, n) {
						...
						var o = new Gt("align-".concat(n)), l = t.map(function(t) {
							return (e = "align-".concat(t), a("div", "".concat(kt, "-item")).child(new Gt(e))).on("click", function() {
								i.setTitle(t), i.change(t);
							});
							var e;
						});
						return i = Mn(this, (r = Nn(e)).call.apply(r, [
							this,
							o,
							"auto",
							!0,
				...
				var Yn = function(t) {
					function e(t) {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Bn(this, Ln(e).call(this, "align", "", t));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var Gn = function(t) {
					function e(t) {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Zn(this, Kn(e).call(this, "valign", "", t));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var or = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), er(this, rr(e).apply(this, arguments));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
					...
					}(e, wn), n = e, (r = [
						{
							...
							value: function() {
								var t = this, n = this.tag;
								return nr(rr(e.prototype), "element", this).call(this).child(new Gt(n)).on("click", function() {
									return t.click();
								});
							}
						},
				...
				var fr = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), cr(this, sr(e).call(this, "autofilter"));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var vr = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), pr(this, dr(e).call(this, "font-bold", "Ctrl+B"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var kr = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), gr(this, mr(e).call(this, "font-italic", "Ctrl+I"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var jr = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Sr(this, xr(e).call(this, "strike", "Ctrl+U"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var Ar = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Cr(this, Tr(e).call(this, "underline", "Ctrl+U"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				function Hr(t) {
					var e = this;
					return a("td", "").child(a("div", "".concat(kt, "-color-palette-cell")).on("click.stop", function() {
						return e.change(t);
				...
				var Mr = function t() {
					...
					(function(t, e) {
						if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
					})(this, t), this.el = a("div", "".concat(kt, "-color-palette")), this.change = function() {};
					var o = a("table", "").children((e = a("tbody", "")).children.apply(e, [(n = a("tr", "".concat(kt, "-theme-color-placeholders"))).children.apply(n, Rr(Ir.map(function(t) {
						return Hr.call(i, t);
					})))].concat(Rr(Dr.map(function(t) {
						var e;
						return (e = a("tr", "".concat(kt, "-theme-colors"))).children.apply(e, Rr(t.map(function(t) {
							return Hr.call(i, t);
						})));
					})), [(r = a("tr", "".concat(kt, "-standard-colors"))).children.apply(r, Rr(zr.map(function(t) {
						return Hr.call(i, t);
					})))])));
					this.el.child(o);
				};
				...
				var Br = function(t) {
					function e(t, n) {
						...
						var i = new Gt(t).css("height", "16px").css("border-bottom", "3px solid ".concat(n)), o = new Mr();
				...
				var Zr = [
					...
					function e(t) {
						...
						var i = new Gt("line-type"), o = 0, l = Zr.map(function(e, n) {
							return a("div", "".concat(kt, "-item state ").concat(t === e[0] ? "checked" : "")).on("click", function() {
								l[o].toggle("checked"), l[n].toggle("checked"), o = n, r.hide(), r.change(e);
							}).child(a("div", "".concat(kt, "-line-type")).html(e[1]));
						});
						return r = Yr(this, (n = $r(e)).call.apply(n, [
							this,
							i,
							"auto",
							!1,
				...
				function ti(t) {
					var e = this;
					return a("td", "").child(a("div", "".concat(kt, "-border-palette-cell")).child(new Gt("border-".concat(t))).on("click", function() {
						e.mode = t;
				...
				var ei = function t() {
					...
					(function(t, e) {
						if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
					})(this, t), this.color = "#000", this.style = "thin", this.mode = "all", this.change = function() {}, this.ddColor = new Br("line-color", this.color), this.ddColor.change = function(t) {
						r.color = t;
					}, this.ddType = new Kr(this.style), this.ddType.change = function(t) {
						r.style = Gr(t, 1)[0];
					}, this.el = a("div", "".concat(kt, "-border-palette"));
					var i = Qr(a("tr", "").children(a("td", "".concat(kt, "-border-palette-left")).child(Qr((e = a("tr", "")).children.apply(e, Jr([
						"all",
						"inside",
						"horizontal",
						"vertical",
						...
						return ti.call(r, t);
					}))))), a("td", "".concat(kt, "-border-palette-right")).children(a("div", "".concat(kt, "-toolbar-btn")).child(this.ddColor.el), a("div", "".concat(kt, "-toolbar-btn")).child(this.ddType.el))));
					this.el.child(i);
				};
				function ni(t) {
				...
				var ai = function(t) {
					function e() {
						...
						var n = new Gt("border-all"), r = new ei();
				...
				var hi = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), si(this, ui(e).call(this, "border"));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				function vi(t, e, n) {
					return (vi = "undefined" != typeof Reflect && Reflect.get ? Reflect.get : function(t, e, n) {
						var r = function(t, e) {
				...
				var mi = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), yi(this, bi(e).apply(this, arguments));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						...
						value: function() {
							var t = this;
							return vi(bi(e.prototype), "element", this).call(this).child(new Gt(this.tag)).on("click", function() {
				...
				var xi = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), ki(this, Oi(e).call(this, "clearformat"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var Pi = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), _i(this, Ci(e).call(this, "paintformat"));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var Hi = function(t) {
					function e(t) {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Ii(this, Di(e).call(this, "color", void 0, t));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var qi = function(t) {
					function e(t) {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Fi(this, Wi(e).call(this, "bgcolor", void 0, t));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var Xi = function(t) {
					function e() {
						...
						var r = Pe.map(function(t) {
							return a("div", "".concat(kt, "-item")).on("click", function() {
								n.setTitle("".concat(t.pt)), n.change(t);
							}).child("".concat(t.pt));
						});
						return n = Ui(this, (t = Yi(e)).call.apply(t, [
							this,
							"10",
							"60px",
							!0,
				...
				var to = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Ji(this, Gi(e).call(this, "font-size"));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var ao = function(t) {
					function e() {
						...
						return n = ro(this, (t = io(e)).call.apply(t, [
							this,
							Te[0].title,
							"160px",
							!0,
				...
				var ho = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), so(this, uo(e).call(this, "font-name"));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var jo = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), So(this, xo(e).call(this, "format"));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var Ro = function(t) {
					function e() {
						...
						return n = To(this, (t = Po(e)).call.apply(t, [
							this,
							new Gt("formula"),
							"180px",
							!0,
				...
				var No = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), zo(this, Ho(e).call(this, "formula"));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var Bo = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Wo(this, Vo(e).call(this, "freeze"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var Zo = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Yo(this, $o(e).call(this, "merge"));
					}
					var n, r, i;
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
				...
				var ta = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), Jo(this, Go(e).call(this, "redo", "Ctrl+Y"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var oa = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), na(this, ra(e).call(this, "undo", "Ctrl+Z"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var ua = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), la(this, ca(e).call(this, "print", "Ctrl+P"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var ya = function(t) {
					function e() {
						return function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						}(this, e), ha(this, pa(e).call(this, "textwrap"));
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
				...
				var Sa = function(t) {
					function e() {
						var t;
						ga(this, e);
						var n = new Gt("ellipsis"), r = a("div", "".concat(kt, "-toolbar-more"));
						return (t = ma(this, wa(e).call(this, n, "auto", !1, "bottom-right", r))).moreBtns = r, t.contentEl.css("max-width", "420px"), t;
					}
					return ka(e, In), e;
				}(), xa = function(t) {
					function e() {
						var t;
						return ga(this, e), (t = ma(this, wa(e).call(this, "more"))).el.hide(), t;
					}
					var n, r, i;
					return ka(e, _n), n = e, (r = [
						{
							key: "dropdown",
							value: function() {
								return new Sa();
				...
				function Ca() {
					var t, e, n = this.el, r = this.btns, i = this.moreEl, o = this.btns2, a = i.dd, l = a.moreBtns, c = a.contentEl;
				...
				var Ta = function() {
					function t(e, n) {
						...
						], this.el = a("div", "".concat(kt, "-toolbar")), this.btns = a("div", "".concat(kt, "-toolbar-btns")), this.items.forEach(function(t) {
				...
				var Ra = function() {
					function t(e, n) {
						...
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, t), this.title = e, this.el = a("div", "".concat(kt, "-modal")).css("width", o).children(a("div", "".concat(kt, "-modal-header")).children(new Gt("close").on("click.stop", function() {
							return i.hide();
					...
					return e = t, (n = [{
						...
						value: function() {
							var t = this;
							this.dimmer = a("div", "".concat(kt, "-dimmer active")), document.body.appendChild(this.dimmer.el);
							var e = this.el.show().box(), n = e.width, r = e.height, i = document.documentElement, o = i.clientHeight, l = i.clientWidth;
							this.el.offset({
								left: (l - n) / 2,
								top: (o - r) / 3
						...
						key: "hide",
						value: function() {
							this.el.hide(), document.body.removeChild(this.dimmer.el), vt(window, "keydown", window.xkeydownEsc), delete window.xkeydownEsc;
						}
				...
				var Da = function() {
					function t(e, n) {
						...
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, t), this.vchange = function() {}, this.el = a("div", "".concat(kt, "-form-input")), this.input = a("input", "").css("width", e).on("input", function(t) {
							return r.vchange(t);
				...
				var Ha = function() {
					function t(e, n, r) {
						...
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, t), this.key = e, this.getTitle = o, this.vchange = function() {}, this.el = a("div", "".concat(kt, "-form-select")), this.suggest = new Yt(n.map(function(t) {
							return {
								key: t,
								title: i.getTitle(t)
							};
					...
					return e = t, (n = [
						...
						},
						{
							...
							value: function() {
								...
								if ((e.type || e.pattern) && !(e.pattern || Na[e.type]).test(i)) return n.html(L("validation.notMatch")), r.addClass("error"), !1;
								return r.removeClass("error"), !0;
							}
						}
					]) && Ma(e.prototype, n), r && Ma(e, r), t;
				}();
				function Wa(t) {
				...
				var Ua = 100, Ya = function(t) {
					function e() {
						var t;
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, e);
						var n = new Fa(new Ha("cell", ["cell"], "100%", function(t) {
							return L("dataValidation.modeType.".concat(t));
						}), { required: !0 }, "".concat(L("dataValidation.range"), ":"), Ua), r = new Fa(new Da("120px", "E3 or E3:F12"), {
							required: !0,
							pattern: /^([A-Z]{1,2}[1-9]\d*)(:[A-Z]{1,2}[1-9]\d*)?$/
						}), i = new Fa(new Ha("list", [
							"list",
							"number",
							"date",
							"phone",
						...
						}), { required: !0 }, "".concat(L("dataValidation.criteria"), ":"), Ua), o = new Fa(new Ha("be", [
							"be",
							"nbe",
							"eq",
							"neq",
						...
						}), { required: !0 }).hide(), l = new Fa(new Da("70px", "10"), { required: !0 }).hide(), c = new Fa(new Da("70px", "100"), {
							required: !0,
							type: "number"
						}).hide(), s = new Fa(new Da("120px", "a,b,c"), { required: !0 }), u = new Fa(new Da("70px", "10"), {
							required: !0,
							type: "number"
						}).hide();
						return (t = qa(this, Ba(e).call(this, L("contextmenu.validation"), [
							a("div", "".concat(kt, "-form-fields")).children(n.el, r.el),
							a("div", "".concat(kt, "-form-fields")).children(i.el, o.el, l.el, c.el, u.el, s.el),
							a("div", "".concat(kt, "-buttons")).children(new ve("cancel").on("click", function() {
					...
					return function(t, e) {
						...
						},
						{
							...
							value: function(t) {
								if (t) {
									var e = this.mf, n = this.rf, r = this.cf, i = this.of, o = this.svf, a = this.vf, l = this.minvf, c = this.maxvf, s = t.mode, u = t.ref, f = t.validator || { type: "list" }, h = f.type, p = f.operator, d = f.value;
				...
				function Za(t) {
					var e = this;
					return Xa("state").child(L("sort.".concat(t))).on("click.stop", function() {
				...
				var Ja = function() {
					function t() {
						...
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, t), this.filterbEl = a("div", "".concat(kt, "-body")), this.filterhEl = a("div", "".concat(kt, "-header state")).on("click.stop", function() {
							return e.filterClick(0, "all");
						}), this.el = a("div", "".concat(kt, "-sort-filter")).children(this.sortAscEl = Za.call(this, "asc"), this.sortDescEl = Za.call(this, "desc"), Xa("divider"), a("div", "".concat(kt, "-filter")).children(this.filterhEl, this.filterbEl), a("div", "".concat(kt, "-buttons")).children(new ve("cancel").on("click", function() {
							...
							value: function(t, e, n, r) {
								...
								null !== r ? (this.sort = r.order, i.checked(r.asc()), o.checked(r.desc())) : (this.sortDesc = null, i.checked(!1), o.checked(!1)), this.values = Object.keys(e), this.filterValues = n ? Array.from(n.value) : Object.keys(e), function(t) {
									...
									n.html(""), Object.keys(t).forEach(function(i, o) {
										...
										n.child(a("div", "".concat(kt, "-item state ").concat(c)).on("click.stop", function() {
											return e.filterClick(o, i);
										}).children("" === i ? L("filter.empty") : i, a("div", "label").html("(".concat(l, ")"))));
									});
								}.call(this, e, n), Ka.call(this);
							}
						},
						{
							key: "setOffset",
				...
				function Ga(t, e) {
					var n = a("div", "".concat(kt, "-toast")), r = a("div", "".concat(kt, "-dimmer active"));
					n.children(a("div", "".concat(kt, "-toast-header")).children(new Gt("close").on("click.stop", function() {
						document.body.removeChild(n.el), document.body.removeChild(r.el);
					}), t), a("div", "".concat(kt, "-toast-content")).html(e)), document.body.appendChild(n.el), document.body.appendChild(r.el);
				...
				function nl(t, e, n) {
					var r = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3], i = arguments.length > 4 && void 0 !== arguments[4] && arguments[4];
					if (-1 !== e || -1 !== n) {
				...
				function rl(t, e) {
					var n = this.selector, r = this.data, i = r.rows, o = r.cols, a = tl(n.indexes, 2), l = a[0], c = a[1], s = n.range, u = s.eri, f = s.eci;
					if (t) {
						var h = tl(n.moveIndexes, 2);
						l = h[0], c = h[1];
					}
					"left" === e ? c > 0 && (c -= 1) : "right" === e ? (f !== c && (c = f), c < o.len - 1 && (c += 1)) : "up" === e ? l > 0 && (l -= 1) : "down" === e ? (u !== l && (l = u), l < i.len - 1 && (l += 1)) : "row-first" === e ? c = 0 : "row-last" === e ? c = o.len - 1 : "col-first" === e ? l = 0 : "col-last" === e && (l = i.len - 1), t && (n.moveIndexes = [l, c]), nl.call(this, t, l, c), function() {
						var t = this.data, e = this.verticalScrollbar, n = this.horizontalScrollbar, r = t.getSelectedRect(), i = r.l, o = r.t, a = r.left, l = r.top, c = r.width, s = r.height, u = this.getTableOffset();
				...
				function il() {
					var t = this.data, e = this.verticalScrollbar, n = this.getTableOffset().height, r = t.exceptRowTotalHeight(0, -1);
				...
				function al() {
					var t = this.tableEl, e = this.overlayerEl, n = this.overlayerCEl, r = this.table, i = this.toolbar, o = this.selector, a = this.el, l = this.getTableOffset(), c = this.getRect();
					t.attr(c), e.offset(c), n.offset(l), a.css("width", "".concat(c.width, "px")), il.call(this), ol.call(this), function() {
						var t = this.selector, e = this.data, n = this.editor, r = tl(e.freeze, 2), i = r[0], o = r[1];
						if (i > 0 || o > 0) {
				...
				function hl(t) {
					var e = this, n = this.selector, r = this.data, i = this.table, o = this.sortFilter, a = t.offsetX, l = t.offsetY, c = t.target.className === "".concat(kt, "-selector-corner"), s = r.getCellRectByXY(a, l), u = s.left, f = s.top, h = s.width, p = s.height, d = s.ri, y = s.ci, v = r.autoFilter;
					if (v.includes(d, y) && u + h - 20 < a && f + p - 20 < l) {
						var b = v.items(y, function(t, e) {
							return r.rows.getCell(t, e);
						});
						o.hide(), o.set(y, b, v.getFilter(y), v.getSort(y)), o.setOffset({
							left: u,
							top: f + p + 2
						});
						return;
					}
					t.shiftKey || (c ? n.showAutofill(d, y) : nl.call(this, !1, d, y), mt(window, function(t) {
						var i = r.getCellRectByXY(t.offsetX, t.offsetY);
						d = i.ri, y = i.ci, c ? n.showAutofill(d, y) : 1 !== t.buttons || t.shiftKey || nl.call(e, !0, d, y, !0, !0);
					}, function() {
						c && n.arange && "read" !== r.settings.mode && r.autofill(n.arange, "all", function(t) {
							return Ga("Tip", t);
						}) && i.render(), n.hideAutofill(), function() {
							var t = this.toolbar;
							t.paintformatActive() && (ul.call(this, "format"), ll.call(this), t.paintformatToggle());
						}.call(e);
				...
				function dl() {
					...
					"read" !== e.settings.mode && (pl.call(this), t.setCell(e.getSelectedCell(), e.getSelectedValidator()), ll.call(this));
				}
				function yl(t) {
					var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "finished", n = this.data, r = this.table;
					if ("read" !== n.settings.mode) {
				...
				function bl(t, e) {
					...
					else if ("freeze" === t) if (e) {
						var r = n.selector, i = r.ri, o = r.ci;
						this.freeze(i, o);
					} else this.freeze(0, 0);
					else n.setSelectedCellAttr(t, e), "formula" !== t || n.selector.multiple() || dl.call(this), al.call(this);
				}
				function gl() {
					var t, e, n, r, i, o, a = this, l = this.selector, c = this.overlayerEl, s = this.rowResizer, u = this.colResizer, f = this.verticalScrollbar, h = this.horizontalScrollbar, p = this.editor, d = this.contextMenu, y = this.toolbar, v = this.modalValidation, b = this.sortFilter;
					c.on("mousemove", function(t) {
						(function(t) {
							if (0 === t.buttons && t.target.className !== "".concat(kt, "-resizer-hover")) {
						...
						p.clear(), d.hide(), 2 === t.buttons ? (a.data.xyInSelectedRect(t.offsetX, t.offsetY) ? d.setPosition(t.offsetX, t.offsetY) : (hl.call(a, t), d.setPosition(t.offsetX, t.offsetY)), t.stopPropagation()) : 2 === t.detail ? dl.call(a) : hl.call(a, t);
					}).on("mousewheel.stop", function(t) {
						(function(t) {
							var e = this.verticalScrollbar, n = this.horizontalScrollbar, r = this.data, i = e.scroll().top, o = n.scroll().left, a = r.rows, l = r.cols, c = t.deltaY, s = t.deltaX, u = function(t, e) {
								var n = t, r = 0;
								do
									r = e(n), n += 1;
								while (r <= 0);
							...
							/Firefox/i.test(window.navigator.userAgent) && el(f(t.detail), 50), d === p && el(function(t) {
								if (t > 0) {
									var e = r.scroll.ci + 1;
									if (e < l.len) {
					...
					}, t = c.el, n = (e = { move: function(t, e) {
						(function(t, e) {
							var n = this.verticalScrollbar, r = this.horizontalScrollbar, i = n.scroll().top, o = r.scroll().left;
							"left" === t || "right" === t ? r.move({ left: o - e }) : "up" !== t && "down" !== t || n.move({ top: i - e });
						}).call(a, t, e);
					} }).move, r = e.end, i = 0, o = 0, yt(t, "touchstart", function(t) {
						...
						(function(t, e) {
							...
							this.data.rows.setHeight(n, e), r.render(), i.resetAreaOffset(), il.call(this), pl.call(this);
						}).call(a, t, e);
					}, u.finishedFn = function(t, e) {
						(function(t, e) {
							var n = t.ci, r = this.table, i = this.selector;
							this.data.cols.setWidth(n, e), r.render(), i.resetAreaOffset(), ol.call(this), pl.call(this);
						}).call(a, t, e);
						...
						"validation" === t ? v.setValue(a.data.getSelectedValidation()) : "copy" === t ? cl.call(a) : "cut" === t ? sl.call(a) : "paste" === t ? ul.call(a, "all") : "paste-value" === t ? ul.call(a, "text") : "paste-format" === t ? ul.call(a, "format") : "hide" === t ? function() {
						...
						if (a.focusing) {
							...
							if (r || o) switch (e) {
								...
								case 40:
									...
									break;
								case 32:
									nl.call(a, !1, -1, a.data.selector.ci, !1), t.preventDefault();
									break;
								case 66:
									y.trigger("bold");
									break;
								...
								switch (e) {
									...
									case 40:
										...
										break;
									case 9:
										p.clear(), rl.call(a, !1, i ? "left" : "right"), t.preventDefault();
										break;
									case 13:
										p.clear(), rl.call(a, !1, i ? "up" : "down"), t.preventDefault();
										break;
									case 8: vl.call(a, "delete-cell-text"), t.preventDefault();
								}
								"Delete" === n ? (vl.call(a, "delete-cell-text"), t.preventDefault()) : e >= 65 && e <= 90 || e >= 48 && e <= 57 || e >= 96 && e <= 105 || "=" === t.key ? (yl.call(a, t.key, "input"), dl.call(a)) : 113 === e && dl.call(a);
							}
						}
					});
				}
				var ml = function() {
					function t(e, n) {
						...
						(function(t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
						})(this, t), this.eventMap = function() {
							var t = /* @__PURE__ */ new Map();
							function e(e, n) {
								var r;
								return t.has(e) && (r = t.get(e), Array.isArray(r) && r.push(n) || !1) || t.set(e, [].concat(n));
							}
							function n(e, n) {
								var r, i;
								return t.has(e) && (r = t.get(e), (i = r.indexOf(n)) >= 0 && r.splice(i, 1) && 0 === t.get(e).length && t.delete(e));
							}
							return {
								get current() {
									return t;
								...
								fire: function(e, n) {
									return t.has(e) && function() {
										var r = t.get(e), i = !0, o = !1, a = void 0;
										try {
						...
						this.el = a("div", "".concat(kt, "-sheet")), this.toolbar = new Ta(n, o.width, !l), this.print = new pn(n), e.children(this.toolbar.el, this.el, this.print.el), this.data = n, this.tableEl = a("canvas", "".concat(kt, "-table")), this.rowResizer = new St(!1, n.rows.height), this.colResizer = new St(!0, n.cols.minWidth), this.verticalScrollbar = new Et(!0), this.horizontalScrollbar = new Et(!1), this.editor = new fe(Fe, function() {
							return r.getTableOffset();
						}, n.rows.height), this.modalValidation = new Ya(), this.contextMenu = new gn(function() {
							return r.getRect();
					...
					return e = t, (n = [
						...
						},
						{
							key: "trigger",
							value: function(t) {
								for (var e = this.eventMap, n = arguments.length, r = new Array(n > 1 ? n - 1 : 0), i = 1; i < n; i++) r[i - 1] = arguments[i];
								e.fire(t, r);
							}
						},
						{
							key: "resetData",
							value: function(t) {
								this.editor.clear(), this.data = t, il.call(this), ol.call(this), this.toolbar.resetData(t), this.print.resetData(t), this.selector.resetData(t), this.table.resetData(t);
							}
						},
						{
							key: "loadData",
				...
				function jl(t, e) {
					return !e || "object" !== kl(e) && "function" != typeof e ? function(t) {
						if (void 0 === t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
						return t;
					}(t) : e;
				}
				...
				var Tl = function(t) {
					function e(t) {
						...
						return (n = jl(this, _l(e).call(this, r, "auto", !1, "top-left"))).contentClick = t, n;
					}
					return function(t, e) {
						if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
						t.prototype = Object.create(e && e.prototype, { constructor: {
						...
						value: function(t) {
							var e = this, n = t.map(function(t, n) {
								return a("div", "".concat(kt, "-item")).css("width", "150px").css("font-weight", "normal").on("click", function() {
				...
				function Al() {
					...
					return Pl.map(function(e) {
						return function(t) {
							var e = this;
							return a("div", "".concat(kt, "-item")).child(t.title()).on("click", function() {
								e.itemClick(t.key), e.hide();
							});
						}.call(t, e);
					});
				...
				var Rl = function() {
					function t() {
						var e;
						Sl(this, t), this.el = (e = a("div", "".concat(kt, "-contextmenu")).css("width", "160px")).children.apply(e, Ol(Al.call(this))).hide(), this.itemClick = function() {};
					}
					return El(t, [{
						key: "hide",
						value: function() {
					...
					function t() {
						var e = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function() {}, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function() {}, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function() {}, o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : function() {};
						Sl(this, t), this.swapFunc = r, this.updateFunc = o, this.dataNames = [], this.activeEl = null, this.deleteEl = null, this.items = [], this.moreEl = new Tl(function(t) {
							e.clickSwap2(e.items[t]);
						}), this.contextMenu = new Rl(), this.contextMenu.itemClick = i, this.el = a("div", "".concat(kt, "-bottombar")).children(this.contextMenu.el, this.menuEl = a("ul", "".concat(kt, "-menu")).child(a("li", "").children(new Gt("add").on("click", function() {
							n();
				...
				var Nl = function() {
					function t(e) {
						...
						this.options = function(t) {
							for (var e = 1; e < arguments.length; e++) {
								...
								e % 2 ? zl(n, !0).forEach(function(e) {
									Hl(t, e, n[e]);
								}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : zl(n).forEach(function(e) {
									Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(n, e));
								});
							}
							return t;
						}({ showBottomBar: !0 }, r), this.sheetIndex = 1, this.datas = [], "string" == typeof e && (i = document.querySelector(e)), this.bottombar = this.options.showBottomBar ? new Il(function() {
							var t = n.addSheet();
							n.sheet.resetData(t);
						}, function(t) {
							var e = n.datas[t];
					...
					return e = t, r = [{
					...
					}], (n = [
						{
							key: "addSheet",
							value: function(t) {
								var e = this, n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], r = t || "sheet".concat(this.sheetIndex), i = new pt(r, this.options);
								return i.change = function() {
									for (var t, n = arguments.length, r = new Array(n), i = 0; i < n; i++) r[i] = arguments[i];
									(t = e.sheet).trigger.apply(t, ["change"].concat(r));
								}, this.datas.push(i), null !== this.bottombar && this.bottombar.addItem(r, n), this.sheetIndex += 1, i;
							}
						},
						{
							key: "deleteSheet",
							value: function() {
								if (null !== this.bottombar) {
									var t = Dl(this.bottombar.deleteItem(), 2), e = t[0], n = t[1];
						...
						},
						{
							...
							value: function(t) {
								...
								if (null !== this.bottombar && this.bottombar.clear(), this.datas = [], e.length > 0) for (var n = 0; n < e.length; n += 1) {
					...
					return new Nl(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {});
				};
				window && (window.x_spreadsheet = Fl, window.x_spreadsheet.locale = function(t, e) {
					return Y(t, e);
				});
				e.default = Nl;
			}
		...
		*/
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin=\"dsh-excel-chat\"]") === null) {
			...
			style.textContent = xspreadsheet_css_default;
				...
				try {
					...
					const maxCols = Math.max(...sheets.map((sheet) => {
						const cols = sheet.cells.map((cell) => {
							...
							return match ? [...match[1]].reduce((acc, char) => acc * 26 + (char.toUpperCase().charCodeAt(0) - 64), 0) : 0;
						});
		...
		function DiffFromResult(result) {
			...
			const nodes = [];
			if (lines.length > 0) nodes.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
				style: {
					fontSize: 12,
					whiteSpace: "pre-wrap",
					margin: "0 0 8px"
			...
			if (stepRows.length > 0) nodes.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
				style: {
					fontSize: 12,
					whiteSpace: "pre-wrap",
					margin: "0 0 8px"
				},
				children: stepRows.join("\n")
			}, "steps"));
			if (rows.length > 0) {
				...
				nodes.push(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
					style: {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", { children: [
						...
						"修复前",
						"修复后"
					].map((label) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
						style: cellStyle(true),
						children: label
					}, label)) }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: rows.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
		...
		function ExcelToolView(props) {
			...
			const [dataVersion, setDataVersion] = (0, react.useState)(0);
			...
			if (TABLE_TOOLS.has(toolName) && parsed !== null) {
				...
				if (Array.isArray(value.sheets) && value.sheets.length > 0) {
					const record = parsed;
					const filePath = record.path ?? (typeof record.previewPath === "string" ? record.previewPath.replace(/\.preview\.html$/i, ".xlsx") : void 0);
					const inPlace = Boolean(filePath && commandsRemote);
					const commitEdit = async (cellId, newValue) => {
						if (!inPlace || !filePath) {
							if (!newValue) return;
						...
						try {
							const result = (await commandsRemote.execute(String(props.sessionId), `/excel-set ${JSON.stringify({
								path: filePath,
								cell: cellId,
								value: newValue
							})}`)).result;
							if (result.kind === "success") setSavedNote({
								kind: "success",
								text: `已就地保存：${result.text ?? `${cellId} = ${newValue}`}`
							});
							else setSavedNote({
								kind: "error",
								text: `保存失败：${result.text ?? "未知错误"}`
							});
						} catch (error) {
							setSavedNote({
								kind: "error",
					...
					const rollback = async () => {
						...
						try {
							const result = (await commandsRemote.execute(String(props.sessionId), `/excel-undo ${JSON.stringify({ path: filePath })}`)).result;
							if (result.kind === "success") {
								setDataVersion((version) => version + 1);
								setSavedNote({
									kind: "success",
									text: `已回滚：${result.text ?? ""}`
								});
							} else setSavedNote({
								kind: "error",
								text: `回滚失败：${result.text ?? "未知错误"}`
							});
						} catch (error) {
							setSavedNote({
								kind: "error",
								text: `回滚失败：${error instanceof Error ? error.message : String(error)}`
							});
						}
					};
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SpreadsheetView, {
							sheets: value.sheets,
						...
						savedNote !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								fontSize: 11,
								color: savedNote.kind === "success" ? "#15803d" : "#b91c1c",
								marginTop: 6
							},
							children: savedNote.text
						}),
						(canEdit || inPlace) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								fontSize: 11,
								color: "#6b7280",
								marginTop: 6
							},
							children: [inPlace ? "改完回车 = 就地保存本地文件（自动备份 .bak，可撤销）" : "改完回车：变更会通过对话让 agent 执行 set 并重新预览", inPlace && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => {
									rollback();
								},
				...
				if (typeof value.markdown === "string") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
					style: {
						fontSize: 12,
						overflow: "auto",
						whiteSpace: "pre-wrap",
			...
			if (SUMMARY_TOOLS.has(toolName) && parsed !== null && typeof parsed === "object") {
				...
				if (lines.length > 0 || counts.length > 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
					style: {
						fontSize: 12,
						overflow: "auto",
						whiteSpace: "pre-wrap",
		...
		function apply(ctx) {
			commandsRemote = ctx.get("remote.commands") ?? null;
